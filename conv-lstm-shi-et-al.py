...
class ConvLSTMCell(nn.Module):
    def __init__(self, in_dims, hidden_dims, img_size, kernel_size=3):
        ...
        self.W_ci = nn.Parameter(torch.empty(hidden_dims, h, w))
        
        self.b_i = nn.Parameter(torch.empty(hidden_dims)) #bias term
        ...
        self.W_cf = nn.Parameter(torch.empty(hidden_dims, h, w))
        
        self.b_f = nn.Parameter(torch.empty(hidden_dims)) #bias term
        ...
        self.b_c = nn.Parameter(torch.empty(hidden_dims)) #bias term
        ...
        self.b_o = nn.Parameter(torch.empty(hidden_dims)) #bias term
